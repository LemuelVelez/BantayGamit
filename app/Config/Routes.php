...
$routes->group('',['filter'=>'auth'],static function(RouteCollection $routes):void{
 ...
 $routes->group('',['filter'=>'role:admin,barangay_official'],static function(RouteCollection $routes):void{
  $routes->get('equipment/new','EquipmentController::create');$routes->post('equipment','EquipmentController::store');$routes->get('equipment/(:num)/edit','EquipmentController::edit/$1');$routes->post('equipment/(:num)','EquipmentController::update/$1');$routes->post('equipment/(:num)/retire','EquipmentController::retire/$1');$routes->post('equipment/(:num)/restore','EquipmentController::restore/$1');
