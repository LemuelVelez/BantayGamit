...
class CreateBantayGamitSchema extends Migration
{
    public function up(): void
    {
        ...
        $this->forge->addField([
            ...
            'role' => [
                'type' => 'ENUM',
                'constraint' => ['admin', 'barangay_official', 'borrower'],
            ],
            'status' => [
                'type' => 'ENUM',
        ...
        $this->forge->addKey('id', true);
        $this->forge->addUniqueKey('name');
        $this->forge->createTable('equipment_locations', true);
        ...
        $this->forge->addField([
            ...
            'condition' => [
                'type' => 'ENUM',
                'constraint' => ['excellent', 'good', 'fair', 'damaged'],
                'default' => 'good',
            ],
            'status' => [
                'type' => 'ENUM',
        ...
        $this->forge->addForeignKey('category_id', 'equipment_categories', 'id', 'RESTRICT', 'CASCADE');
        $this->forge->addForeignKey('location_id', 'equipment_locations', 'id', 'RESTRICT', 'CASCADE');
        ...
        $this->forge->addField([
            ...
            'status' => [
                'type' => 'ENUM',
                'constraint' => ['pending', 'approved', 'rejected', 'cancelled', 'released', 'returned', 'overdue'],
                'default' => 'pending',
            ],
            'approved_by' => [
                'type' => 'INT',
        ...
        $this->forge->addKey(['borrower_id', 'status']);
        ...
        $this->forge->addKey('id', true);
        $this->forge->addUniqueKey(['borrow_request_id', 'equipment_id']);
        $this->forge->addKey('equipment_id');
        $this->forge->addForeignKey('borrow_request_id', 'borrow_requests', 'id', 'CASCADE', 'CASCADE');
    ...
    public function down(): void
    {
        ...
        $this->forge->dropTable('borrow_request_items', true);
        $this->forge->dropTable('borrow_requests', true);
        $this->forge->dropTable('equipment', true);
        $this->forge->dropTable('equipment_locations', true);
